"""
Water SCARCE Criticality Assessment Script – Overall Criticality Calculation
-----------------------------------------------------------------------------

This script integrates the results from all three dimensions: Supply Risk, Vulnerability, Compliance with Environmental Standards and
Compliance with Social Standards into a single composite Water Criticality Score. It combines the normalised outputs of each dimension,
applies weighting and scaling, and generates country- and region-level maps and tables of overall water criticality.
